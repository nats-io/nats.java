...
public class ConsumerConfigurationTests extends TestBase {
    ...
    public void testUtilityMethods() {
        ...
        assertNull(ConsumerConfiguration.normalizeToInt(null));
        assertEquals(0, ConsumerConfiguration.normalizeToInt(0));
        assertEquals(1, ConsumerConfiguration.normalizeToInt(1));
        assertEquals(INTEGER_UNSET, ConsumerConfiguration.normalizeToInt(INTEGER_UNSET));
        assertEquals(INTEGER_UNSET, ConsumerConfiguration.normalizeToInt(-1));
        assertEquals(INTEGER_UNSET, ConsumerConfiguration.normalizeToInt(Long.MIN_VALUE));
        assertEquals(Integer.MAX_VALUE, ConsumerConfiguration.normalizeToInt(Integer.MAX_VALUE));
        assertEquals(Integer.MAX_VALUE, ConsumerConfiguration.normalizeToInt(Long.MAX_VALUE));
