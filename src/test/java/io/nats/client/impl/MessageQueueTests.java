...
public class MessageQueueTests {
    ...
    public void testAccumulateThrowsOnNonSingleReader() {
        assertThrows(IllegalStateException.class, () -> {
            MessageQueue q = new MessageQueue(false);
            q.push(new NatsMessage.ProtocolMessage(PING));
    ...
    public void testPushPop() throws InterruptedException {
        MessageQueue q = new MessageQueue(false);
        NatsMessage expected = new NatsMessage.ProtocolMessage(PING);
        q.push(expected);
    ...
    public void testMultipleWriters() throws InterruptedException {
        ...
        for (int i=0;i<threads;i++) {
            Thread t = new Thread(() -> {q.push(new NatsMessage.ProtocolMessage(PING));});
            t.start();
        }
    ...
    public void testLength() throws InterruptedException {
        MessageQueue q = new MessageQueue(true);
        NatsMessage msg1 = new NatsMessage.ProtocolMessage(PING);
        NatsMessage msg2 = new NatsMessage.ProtocolMessage(PING);
        NatsMessage msg3 = new NatsMessage.ProtocolMessage(PING);
    ...
    public void testSizeInBytes() throws InterruptedException {
        MessageQueue q = new MessageQueue(true);
        NatsMessage msg1 = new NatsMessage.ProtocolMessage(ONE);
        NatsMessage msg2 = new NatsMessage.ProtocolMessage(TWO);
        NatsMessage msg3 = new NatsMessage.ProtocolMessage(THREE);
        long expected = 0;
