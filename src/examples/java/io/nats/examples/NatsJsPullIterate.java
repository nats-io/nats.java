 ...
 * - a batch size + iterate i.e. subscription.iterate(10)
 *
 ...
 */
public class NatsJsPullIterate extends NatsJsPullSubBase {

    public static void main(String[] args) {
        ExampleArgs exArgs = ExampleArgs.builder()
                .defaultStream("iterate-ack-stream")
                .defaultSubject("iterate-ack-subject")
                .defaultDurable("iterate-ack-durable")
                .build(args);
