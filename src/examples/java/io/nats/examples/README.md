...
```bash
java -cp build/libs/jnats-2.14.2-SNAPSHOT.jar:build/libs/jnats-2.14.2-SNAPSHOT-examples.jar io.nats.examples.NatsPub nats://localhost:4222 test "hello world"
```
...
```bash
java -cp build/libs/jnats-2.14.2-SNAPSHOT.jar:build/libs/jnats-2.14.2-SNAPSHOT-examples.jar io.nats.examples.NatsSub opentls://localhost:4443 test 3
```
