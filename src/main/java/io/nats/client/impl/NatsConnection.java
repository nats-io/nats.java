...
class NatsConnection implements Connection {
        ...
        try {
            ...
            NatsChannelReference newNatsChannel = new NatsChannelReference(
                this.options.getNatsChannelFactory()
                    .connect(uri, Duration.ofNanos(timeoutNanos)));
    ...
    void upgradeToSecureIfNeeded(URI uri, long timeoutNanos) throws IOException, GeneralSecurityException {
        ...
        if (opts.isTLSRequired()) {
            this.natsChannel.upgradeToSecure(Duration.ofNanos(timeoutNanos));
        }
    }
