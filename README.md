...
_WARNING: the repo is moving toward an automated deployment, to avoid confusion the readme is set to 2.6.4 but the build files are set to 2.6.4 so be careful if you build locally._
