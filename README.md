...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.13.2/jnats-2.13.2.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.13.2/jnats-2.13.2.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.13.2/jnats-2.13.2-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.13.2/jnats-2.13.2-examples.jar).
...
dependencies {
   implementation 'io.nats:jnats:2.13.2-SNAPSHOT'
}
```
