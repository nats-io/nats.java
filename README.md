...
**Current Release**: 2.22.0 &nbsp; **Current Snapshot**: 2.22.1-SNAPSHOT
...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.22.0/jnats-2.22.0.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.22.0/jnats-2.22.0.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.22.0/jnats-2.22.0-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.22.0/jnats-2.22.0-examples.jar).
