...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.15.0/jnats-2.15.0.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.15.0/jnats-2.15.0.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.15.0/jnats-2.15.0-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.15.0/jnats-2.15.0-examples.jar).
...
dependencies {
   implementation 'io.nats:jnats:2.15.0-SNAPSHOT'
}
```
