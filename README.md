...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.14.1/jnats-2.14.1.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.14.1/jnats-2.14.1.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.14.1/jnats-2.14.1-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.14.1/jnats-2.14.1-examples.jar).
...
```groovy
dependencies {
    implementation 'io.nats:jnats:2.14.1'
}
```
...
dependencies {
   implementation 'io.nats:jnats:2.14.1-SNAPSHOT'
}
```
