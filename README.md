...
You can download the latest jar at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.11.2/jnats-2.11.2.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.11.2/jnats-2.11.2.jar).

The examples are available at [https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.11.2/jnats-2.11.2-examples.jar](https://search.maven.org/remotecontent?filepath=io/nats/jnats/2.11.2/jnats-2.11.2-examples.jar).
...
Sending and receiving with NATS is as simple as connecting to the nats-server and publishing or subscribing for messages. A number of examples are provided in this repo as described in [Examples Readme](src/examples/java/io/nats/examples/README.md).
